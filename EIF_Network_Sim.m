...
Sx=binornd(1,rx*dt,Nx,length(time))/dt;
...
%%
[Se, Si] = EIF_Network_Euler(Ne, Ni,VT,EL,time,dt,D,taum,taux, taue, taui, ...
    Vth, Vre,Sx,Jex,Jee,Jei,Jix,Jie,Jii);

%% Plot the results

% Get spike times and neuron indices
[SxIndices,SxTimes]=find(Sx>0); 
SxTimes=SxTimes*dt;
